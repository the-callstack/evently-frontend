...
export default function EventsCarousel() {
    ...
    const handleClick = (event) => {
        dispatch(getEventsitem(event.id,true,false))
        navigate(`/ُEventProducts/${event.id}`, {
            state: {
                event: event
            }
        })
                            ...
                            return (
                                <div
                                    ...
                                    <div onClick={() => handleClick(resource)}
                                        ...
                                        style={{ backgroundImage: `url(${resource.eventImgPath || ''})` }}
                                    >
                                        <img
                                            src={resource.eventImgPath || ''}
                                            alt={resource.eventType}
