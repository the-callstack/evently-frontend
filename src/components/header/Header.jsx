          ...
          <nav className="flex justify-between bg-gray-900 text-white w-screen">
            <div className="px-5 xl:px-12 py-6 flex w-full items-center">
              ...
              <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                ...
                <li><Link className="hover:text-gray-200" to="/products">Product</Link></li>
                <li><Link className="hover:text-gray-200" to="/contactus">Contact Us</Link></li>
                <li>
                </li>
              </ul>
              <div className="hidden xl:flex items-center space-x-5">
                <Link className="hover:text-gray-200 hover:underline" to="/auth/signin">   {!isLoggedIn ? "signIn" : "signout"}     </Link>
                ...
                <Link className="flex items-center hover:text-gray-200" to="/profile">
