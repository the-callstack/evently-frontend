...
export const CartCard = () => {
    return (
        <div className="mb-10 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex flex-col items-center pb-10">
                ...
                <div className="flex mt-4 space-x-3 md:mt-6">
                    <p href="#" className="inline-flex items-center px-4 py-2 text-lg font-medium text-center text-white rounded-lg  focus:ring-4 focus:outline-none"> price</p>

                    <p href="#" className="inline-flex items-center px-4 py-2 text-lg font-medium text-center text-white rounded-lg  focus:ring-4 focus:outline-none">quantity</p>
