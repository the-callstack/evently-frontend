...
<footer className="bottom-0 w-full bg-white dark:bg-gray-900">
    <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
       ...
       <div>
            <h2 className="mb-6 text-3xl font-semibold text-gray-500 uppercase dark:text-gray-400 "></h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <p className="pt-9 text-3xl pt-234">Evently</p>
                </li>
            </ul>
        </div>
    </div>
    <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="#">Evently™</a>. All Rights Reserved.
        </span>
