...
<footer class="fixed bottom-0 w-full bg-white dark:bg-gray-900">
    <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
       ...
       <div>
            <h2 class="mb-6 text-3xl font-semibold text-gray-500 uppercase dark:text-gray-400 "></h2>
            <ul class="text-gray-500 dark:text-gray-400">
                <li class="mb-4">
                    <p class="pt-9 text-3xl pt-234">Evently</p>
                </li>
            </ul>
        </div>
    </div>
    <div class="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2022 <a href="#">Evently™</a>. All Rights Reserved.
        </span>
